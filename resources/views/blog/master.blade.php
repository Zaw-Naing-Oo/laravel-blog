...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;0,500;0,600;0,700;0,900;1,200;1,300&family=Padauk:wght@400;700&display=swap" rel="stylesheet">
            ...
            <ul id="menu-top-right-menu" class="navbar-nav ms-auto mb-2 mb-md-0 ">
                ...
                <li id="menu-item-11"
                    class="menu-item menu-item-type-custom menu-item-object-custom nav-item nav-item-11"><a
                        href="{{ route('register') }}" class="nav-link ">Register</a>
                </li>
            </ul>
        </div>
    </div>
